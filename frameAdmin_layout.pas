...
type
  TFrameLayout = class(TFrame)
    ...
    labelTotal: TcxLabel;
    labelJmlKapasitas: TcxLabel;
    cxGrid1DBTableView1: TcxGridDBTableView;
    cxGrid1Level1: TcxGridLevel;
    cxGrid1: TcxGrid;
    labelDataPeserta: TcxLabel;
    panelTop: TPanel;
    panelData: TPanel;
    Shape1: TShape;
    panelContainerTotal: TPanel;
    panelContainerTerisi: TPanel;
    Shape2: TShape;
    panelTerisi: TPanel;
    labelTerisi: TcxLabel;
    labelJmlTerisi: TcxLabel;
    panelContainerTersisa: TPanel;
    Shape3: TShape;
    panelTersisa: TPanel;
    labelTersisa: TcxLabel;
    labelJmlTersisa: TcxLabel;
  private
